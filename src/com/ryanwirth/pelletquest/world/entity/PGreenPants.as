package com.ryanwirth.pelletquest.world.entity
{
	 ...
	 * @author Ryan Wirth
	 */
	public class PGreenPants extends EntityPart
	{
		[Embed(source = "assets/EMale.xml", mimeType = "application/octet-stream")]
		private static const AtlasXml:Class;
		
		// Embed the Atlas Texture:
		[Embed(source = "assets/PGreenPants.png")]
		...
		public function PGreenPants(initialAnimationType:String, initialDirection:String, frameRate:Number)
		{
