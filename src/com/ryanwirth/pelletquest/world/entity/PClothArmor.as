package com.ryanwirth.pelletquest.world.entity
{
	 ...
	 * @author Ryan Wirth
	 */
	public class PClothArmor extends EntityPart
	{
		[Embed(source = "assets/EMale.xml", mimeType = "application/octet-stream")]
		private static const AtlasXml:Class;
		
		// Embed the Atlas Texture:
		[Embed(source = "assets/PClothArmor.png")]
		...
		public function PClothArmor(initialAnimationType:String, initialDirection:String, frameRate:Number)
		{
