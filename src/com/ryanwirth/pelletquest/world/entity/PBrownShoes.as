package com.ryanwirth.pelletquest.world.entity
{
	 ...
	 * @author Ryan Wirth
	 */
	public class PBrownShoes extends EntityPart
	{
		[Embed(source = "assets/EMale.xml", mimeType = "application/octet-stream")]
		private static const AtlasXml:Class;
		
		// Embed the Atlas Texture:
		[Embed(source = "assets/PBrownShoes.png")]
		...
		public function PBrownShoes(initialAnimationType:String, initialDirection:String, frameRate:Number)
		{
