package io.arkeus.tiled {
	...
	public class TiledUtils {
		 ...
		 */
		public static function stringToTileData(string:String, mapWidth:uint, encoding:String, compression:String):Vector.<Vector.<uint>> {
		 ...
		 */
		private static function byteArrayToMapData(data:ByteArray, mapWidth:uint):Vector.<Vector.<uint>> {
			var map:Vector.<Vector.<uint>> = new Vector.<Vector.<uint>>();
