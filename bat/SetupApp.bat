...
:: Android packaging
set AND_CERT_NAME="Ryan Wirth"
set AND_CERT_PASS=Flash.711{play;
set AND_CERT_FILE=cert\PelletQuest.p12
...
set IOS_DEV_CERT_FILE=cert\Development.p12
set IOS_DEV_CERT_PASS=Flash.711{play;
